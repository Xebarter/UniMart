...
export const adminPaths = {
  ...
  careerNew: '/admin/careers/new',
  career: (id: string) => `/admin/careers/${id}`,
  careerApplications: '/admin/careers/applications',
  careerApplication: (id: string) => `/admin/careers/applications/${id}`,
  contact: '/admin/contact',
  contactInquiries: '/admin/contact/inquiries',
  contactInquiry: (id: string) => `/admin/contact/inquiries/${id}`,
  press: '/admin/press',
  subscribers: '/admin/subscribers',
  subscriber: (id: string) => `/admin/subscribers/${id}`,
...
export const adminNav: AdminNavItem[] = [
  ...
  { href: adminPaths.careers, label: 'Careers', icon: Briefcase },
  { href: adminPaths.contact, label: 'Contact', icon: Headset },
  { href: adminPaths.press, label: 'Press', icon: Newspaper },
  { href: adminPaths.subscribers, label: 'Subscribers', icon: Mail },
